...
namespace Assignments
{
    public class PokerHand
    {
        public static string PokerHandRanking(string[] hand)
        {
            ...
            public static bool RoyalStraightFlush(List<int> values, List<string> suits)
            {
            ...
            public static bool Flush(List<string> suits)
            {
            ...
            public static bool StraightFlush(List<int> values, List<string> suits)
            {
            ...
            public static bool Straight(List<int> values)
            {
                var orderedValues = values.OrderBy(x => x).ToList();
                bool result;
            ...
            public static bool FourOfAKind(List<int> values)
            {
            ...
            public static bool ThreeOfAKind(List<int> values)
            {
                foreach (var value in values.Distinct())
                {
                    var counter = 0;
            ...
            public static bool TwoPair(List<int> values)
            {
                var pair = 0;
                var counter = 0;
            ...
            public static bool Pair(List<int> values)
            {
                var pair = 0;
                var counter = 0;
            ...
            public static string HighCard(List<int> values)
            {
